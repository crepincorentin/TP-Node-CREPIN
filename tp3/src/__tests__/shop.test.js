...
const { getPhoneNumbers } = require("../shop");
...
describe("shop.js", () => {
  ...
  describe("getPhoneNumbers", () => {
    it("Doit throw une erreur car la liste des numéros de téléphone est vide", () => {
      expect(() => {
        getPhoneNumbers([]);
      }).toThrow("La liste des numéros de téléphone est vide");
    });
  });
});
